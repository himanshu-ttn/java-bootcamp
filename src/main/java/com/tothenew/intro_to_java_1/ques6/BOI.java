...
public class BOI extends Bank {
    ...
    public BOI(String name, String headOfficeAddress, String chairman, int branchCount, double fdInterestRate, double personalLoanInterestRate, double homeLoanInterestRate, double amount) {
        this.name = name;
    ...
    public boolean withdraw(double amount) {
        if (getBalance() - amount < MINIMUM_BALANCE) {
            System.out.println("BOI require minimum balance of Rs. " + MINIMUM_BALANCE);
            return false;
        }
