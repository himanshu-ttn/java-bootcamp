...
public class ICICI extends Bank {
    ...
    public ICICI(String name, String headOfficeAddress, String chairman, int branchCount, double fdInterestRate, double personalLoanInterestRate, double homeLoanInterestRate, double amount) {
        this.name = name;
    ...
    public boolean withdraw(double amount) {
        if (getBalance() - amount < MINIMUM_BALANCE) {
            System.out.println("ICICI require minimum balance of Rs. " + MINIMUM_BALANCE);
            return false;
        }
