...
public class OrderProcessor {
    public static String processOrderStatus(OrderStatus status) {
        return switch (status) {
            ...
            case SHIPPED -> {
                // Example of more complex logic using yield
                // Like getting the shipment status from logistic server
                String info = "API CALL TO LOGISTIC SERVER THAT WILL RETURN SOME INFO :)";
